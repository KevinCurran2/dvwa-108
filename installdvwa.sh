...
echo -e "    THIS NO LONGER WORKS IN LAB wget --no-check-certificate -O dvwa-1.0.7.zip https://github.com/KevinCurran2/dvwa-108/blob/master/dvwa-1.0.7.zip?raw=true ; so you simply visit https://files.fm/u/rsgpfs4z and click download and save into /tmp folder on backtrack"
echo -e "\n#######################################"
...
cd /tmp
echo -e "Done!\n"
echo "[*] Downloading DVWA... **** already downloaded manually.....!!!!!"
echo -e "Done!\n"
